...
namespace PizzaLibrary.Data
{
    public static class MockData
    {
        ...
        private static List<MenuItem> _menuItemData =
            ...
            new MenuItem("Hawai", 101, "Tomat, ost, løg & kødsauce", MenuType.PIZZESPECIALI),
            new MenuItem("Pastrami", 75, "Tomat, ost løg & pastrami", MenuType.SANDWICHES),
            new MenuItem("Pomfritter", 25, "Kartoffel", MenuType.TILBEHØR),
